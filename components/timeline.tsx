...
const experiences = [
    {
        ...
        period: '2024 - Present',
        description:
            'Lead the development team in building a SaaS platform. Implemented new features, improved performance, and mentored junior developers.',
    },
    {
        title: 'Full stack Developer',
        company: 'Rikkeisoft',
    ...
    {
        title: 'Web Developer',
        company: 'Pando Infinity',
        period: '2022 - 2023',
        description:
            'Built websites and web applications for various clients. Worked with HTML, CSS, JavaScript and React',
    },
]
