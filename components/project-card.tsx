                    ...
                    <div className='p-6 flex-grow'>
                        ...
                        <div className='flex justify-between mt-auto pt-4 border-t border-zinc-700/50'>
                            <Button
                                variant='ghost'
                                size='sm'
                                className={`text-zinc-400 hover:text-white hover:bg-zinc-700/50 invisible`}
                                asChild
                                disabled={!!repoUrl}
                            >
                                <Link
                            ...
                            <Button
                                size='sm'
                                className={`bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-cyan-500 hover:to-blue-500 border-0 invisible`}
                                asChild
                                disabled={!!demoUrl}
                            >
                                <Link
